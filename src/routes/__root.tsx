...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Formula Lab — Engineering Formula Calculator & Learning Platform" },
      { name: "description", content: "Learn, understand and calculate engineering formulas with step-by-step solutions and an AI tutor." },
      { name: "author", content: "Formula Lab" },
      { property: "og:title", content: "Formula Lab — Engineering Formulas Made Interactive" },
      { property: "og:description", content: "Interactive formula calculator, AI Formula Assistant and learning platform for first-year engineering students." },
